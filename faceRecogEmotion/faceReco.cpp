...
#define MAX_PEOPLE 		39
#define P_FEMALE_1624_HAPPY	0
#define P_FEMALE_1624_ANGER	1
#define P_FEMALE_1624_DISGUST	2
#define P_FEMALE_1624_FEAR	3
#define P_FEMALE_1624_SAD	4
#define P_FEMALE_1624_SURPRISE	5
#define P_FEMALE_2534_HAPPY	6
#define P_FEMALE_2534_ANGER	7
#define P_FEMALE_2534_DISGUST	8
#define P_FEMALE_2534_FEAR	9
#define P_FEMALE_2534_SAD	10
#define P_FEMALE_2534_SURPRISE	11
#define P_FEMALE_3549_HAPPY	12
#define P_FEMALE_3549_ANGER	13
#define P_FEMALE_3549_DISGUST	14
#define P_FEMALE_3549_FEAR	15
#define P_FEMALE_3549_SAD	16
#define P_FEMALE_3549_SURPRISE	17
#define P_FEMALE_5000_DISGUST	18
#define P_FEMALE_5000_FEAR	19
#define P_FEMALE_5000_SURPRISE	20
#define P_MALE_1624_HAPPY	21
#define P_MALE_1624_ANGER	22
#define P_MALE_1624_DISGUST	23
#define P_MALE_1624_FEAR	24
#define P_MALE_1624_SAD		25
#define P_MALE_1624_SURPRISE	26
#define P_MALE_2534_HAPPY	27
#define P_MALE_2534_ANGER	28
#define P_MALE_2534_DISGUST	29
#define P_MALE_2534_FEAR	30
#define P_MALE_2534_SAD		31
#define P_MALE_2534_SURPRISE	32
#define P_MALE_3549_HAPPY	33
#define P_MALE_3549_ANGER	34
#define P_MALE_3549_DISGUST	35
#define P_MALE_3549_FEAR	36
#define P_MALE_3549_SAD		37
#define P_MALE_3549_SURPRISE	38
...
//			// to change... if Pierre, RPI talks in french, if Natacha, RPI talks in english
			if (nWho==P_FEMALE_1624_HAPPY) 		{ system("python Female1624Happy.py"); }
			if (nWho==P_FEMALE_1624_ANGER)		{ system("python Female1624Anger.py"); }
			if (nWho==P_FEMALE_1624_DISGUST) 	{ system("python Female1624Disgust.py"); }
			if (nWho==P_FEMALE_1624_FEAR) 		{ system("python Female1624Fear.py"); }
			if (nWho==P_FEMALE_1624_SAD) 		{ system("python Female1624Sad.py"); }
			if (nWho==P_FEMALE_1624_SURPRISE) 	{ system("python Female1624Surprise.py"); }
			if (nWho==P_FEMALE_2534_HAPPY) 		{ system("python Female2534Happy.py"); }
			if (nWho==P_FEMALE_2534_ANGER)		{ system("python Female2534Anger.py"); }
			if (nWho==P_FEMALE_2534_DISGUST) 	{ system("python Female2534Disgust.py"); }
			if (nWho==P_FEMALE_2534_FEAR) 		{ system("python Female2534Fear.py"); }
			if (nWho==P_FEMALE_2534_SAD) 		{ system("python Female2534Sad.py"); }
			if (nWho==P_FEMALE_2534_SURPRISE) 	{ system("python Female2534Surprise.py"); }
			if (nWho==P_FEMALE_3549_HAPPY) 		{ system("python Female3549Happy.py"); }
			if (nWho==P_FEMALE_3549_ANGER)		{ system("python Female3549Anger.py"); }
			if (nWho==P_FEMALE_3549_DISGUST) 	{ system("python Female3549Disgust.py"); }
			if (nWho==P_FEMALE_3549_FEAR) 		{ system("python Female3549Fear.py"); }
			if (nWho==P_FEMALE_3549_SAD) 		{ system("python Female3549Sad.py"); }
			if (nWho==P_FEMALE_3549_SURPRISE) 	{ system("python Female3549Surprise.py"); }
			if (nWho==P_FEMALE_5000_DISGUST) 	{ system("python Female5000Disgust.py"); }
			if (nWho==P_FEMALE_5000_FEAR) 		{ system("python Female5000Fear.py"); }
			if (nWho==P_FEMALE_5000_SURPRISE) 	{ system("python Female5000Surprise.py"); }
			if (nWho==P_MALE_1624_HAPPY) 		{ system("python Male1624Happy.py"); }
			if (nWho==P_MALE_1624_ANGER)		{ system("python Male1624Anger.py"); }
			if (nWho==P_MALE_1624_DISGUST) 		{ system("python Male1624Disgust.py"); }
			if (nWho==P_MALE_1624_FEAR) 		{ system("python Male1624Fear.py"); }
			if (nWho==P_MALE_1624_SAD) 		{ system("python Male1624Sad.py"); }
			if (nWho==P_MALE_1624_SURPRISE) 	{ system("python Male1624Surprise.py"); }
			if (nWho==P_MALE_2534_HAPPY) 		{ system("python Male2534Happy.py"); }
			if (nWho==P_MALE_2534_ANGER)		{ system("python Male2534Anger.py"); }
			if (nWho==P_MALE_2534_DISGUST) 		{ system("python Male2534Disgust.py"); }
			if (nWho==P_MALE_2534_FEAR) 		{ system("python Male2534Fear.py"); }
			if (nWho==P_MALE_2534_SAD) 		{ system("python Male2534Sad.py"); }
			if (nWho==P_MALE_2534_SURPRISE) 	{ system("python Male2534Surprise.py"); }
			if (nWho==P_MALE_3549_HAPPY) 		{ system("python Male3549Happy.py"); }
			if (nWho==P_MALE_3549_ANGER)		{ system("python Male3549Anger.py"); }
			if (nWho==P_MALE_3549_DISGUST) 		{ system("python Male3549Disgust.py"); }
			if (nWho==P_MALE_3549_FEAR) 		{ system("python Male3549Fear.py"); }
			if (nWho==P_MALE_3549_SAD) 		{ system("python Male3549Sad.py"); }
			if (nWho==P_MALE_3549_SURPRISE) 	{ system("python Male3549Surprise.py"); }
//		}
	}
